...
class FRGatherer {
  ...
  /**
   * Legacy method. Roughly corresponds to `stopInstrumentation` or `collectArtifact` depending on type of gatherer.
   * @param {LH.Gatherer.PassContext} passContext
  ...
  async afterPass(passContext, loadData) {
    ...
    return this.collectArtifact({...passContext, dependencies: {}});
  }
}
